...
| Right mouse / Space | Launch a locked missile, or an emergency missile from a pickup |
...
Clear all incoming aircraft to finish a wave. A six-second repair break restores up to 22 hull points, then the next wave begins. Waves grow to at most 20 total enemies, with no more than six active at once. Each sector contains 10 waves, and every tenth wave starts a named three-phase boss. Bosses change movement and attack patterns as their health drops, then award a sector bonus when defeated. Enemy formations rotate through vanguard sweeps, pincers, columns, ringbreaks, and escort screens. Hunters weave, flankers circle, and bombers fire spread shots.
